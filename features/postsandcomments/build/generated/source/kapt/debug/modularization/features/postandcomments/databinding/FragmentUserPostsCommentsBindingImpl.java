...
public class FragmentUserPostsCommentsBindingImpl extends FragmentUserPostsCommentsBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.vm == variableId) {
            setVm((modularization.features.postandcomments.viewmodel.UserPostsWithCommentsViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setVm(@Nullable modularization.features.postandcomments.viewmodel.UserPostsWithCommentsViewModel Vm) {
        this.mVm = Vm;
    }
