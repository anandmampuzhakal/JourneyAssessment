...
public class PostWithCommentsItemBindingImpl extends PostWithCommentsItemBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.usersViewModel == variableId) {
            setUsersViewModel((modularization.features.postandcomments.viewmodel.UserPostsWithCommentsViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setUsersViewModel(@Nullable modularization.features.postandcomments.viewmodel.UserPostsWithCommentsViewModel UsersViewModel) {
