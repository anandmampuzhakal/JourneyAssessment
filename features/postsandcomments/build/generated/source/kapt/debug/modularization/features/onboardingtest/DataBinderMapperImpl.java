...
import modularization.features.onboardingtest.databinding.CardItemBindingImpl;
import modularization.features.onboardingtest.databinding.FragmentGetUserSelectBindingImpl;
import modularization.features.onboardingtest.databinding.FragmentUserPostsCommentsBindingImpl;
import modularization.features.onboardingtest.databinding.PostWithCommentsItemBindingImpl;
...
public class DataBinderMapperImpl extends DataBinderMapper {
  ...
  static {
    INTERNAL_LAYOUT_ID_LOOKUP.put(modularization.features.onboardingtest.R.layout.card_item, LAYOUT_CARDITEM);
    INTERNAL_LAYOUT_ID_LOOKUP.put(modularization.features.onboardingtest.R.layout.fragment_get_user_select, LAYOUT_FRAGMENTGETUSERSELECT);
    INTERNAL_LAYOUT_ID_LOOKUP.put(modularization.features.onboardingtest.R.layout.fragment_user_posts_comments, LAYOUT_FRAGMENTUSERPOSTSCOMMENTS);
    INTERNAL_LAYOUT_ID_LOOKUP.put(modularization.features.onboardingtest.R.layout.post_with_comments_item, LAYOUT_POSTWITHCOMMENTSITEM);
  }
  ...
  public List<DataBinderMapper> collectDependencies() {
    ...
    result.add(new com.nz.anand.westpactechnicalassessment.libraries.actions.DataBinderMapperImpl());
  ...
  private static class InnerLayoutIdLookup {
    ...
    static {
      sKeys.put("layout/card_item_0", modularization.features.onboardingtest.R.layout.card_item);
      sKeys.put("layout/fragment_get_user_select_0", modularization.features.onboardingtest.R.layout.fragment_get_user_select);
      sKeys.put("layout/fragment_user_posts_comments_0", modularization.features.onboardingtest.R.layout.fragment_user_posts_comments);
      sKeys.put("layout/post_with_comments_item_0", modularization.features.onboardingtest.R.layout.post_with_comments_item);
    }
  }
}
