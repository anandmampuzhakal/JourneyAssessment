package modularization.features.postandcomments.databinding;
import modularization.features.postandcomments.R;
import modularization.features.postandcomments.BR;
...
public class CardItemBindingImpl extends CardItemBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.usersViewModel == variableId) {
            setUsersViewModel((modularization.features.postandcomments.viewmodel.GetUsersViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setUsersViewModel(@Nullable modularization.features.postandcomments.viewmodel.GetUsersViewModel UsersViewModel) {
